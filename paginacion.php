...
<?php
        ...
        try{
                $base=new PDO("mysql:host=localhost; dbname=pruebas", "root", "mortimer");
...
/*              while ($registro=$resultado->fetch(PDO::FETCH_ASSOC)){
                        echo "Código Articulo: " . $registro['CODIGOARTICULO'] . " Seccion: " . $registro['SECCION'] ." Nombre Articulo: " . $registro['NOMBREARTICULO'] .  " Precio: " . $registro['PRECIO'] .  " Fecha: " . $registro['FEC>
                }*/
